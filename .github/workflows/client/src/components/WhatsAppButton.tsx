/* ============================================================
   WhatsAppButton — Entrehilos Atelier
...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-30 flex flex-col items-end gap-2">
      {showTooltip && (
        <div
          className="bg-white text-foreground text-sm px-3 py-2 rounded-lg shadow-lg border border-border whitespace-nowrap"
          style={{ fontFamily: "'Source Sans 3', sans-serif" }}
        >
          ¡Escríbenos por WhatsApp!
          <div className="absolute bottom-0 right-4 translate-y-full w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-white" />
        </div>
      )}
      <a
        href={WHATSAPP_URL}
        ...
        style={{ backgroundColor: "#25D366", marginBottom: "4.5rem" }}
